...
#path = "../../img/fourth_run/front55.jpg"
...
## draw contours (hard coded for now)
# largest array would probably be the surface, so next 3 should be the gate
# create a function for testing - maybe permute top 5?
# cv2.drawContours(im, contours, 7, [0, 255, 0], 3)
# cv2.drawContours(im, contours, 31, [0, 255, 0], 3)
# cv2.drawContours(im, contours, 32, [0, 255, 0], 3)
